...
+ #6 槍型接頭
  ...
  + 用UL1015 18AWG 600V單股多蕊線=>AWG18,105度,600V,多芯線(紅色、黑色)
    + https://shop.cpu.com.tw/product/6934/info/
    + https://shop.cpu.com.tw/product/17169/info/
+ #7 香蕉插孔
...
ab30s
(02)8227-6000 由總機為您轉接專業業務人員

### 機殼安裝完成後
+ BOX先連接電表(34465A電錶)的紅、黑線，BNC線
+ BOX連接電腦的USB。
+ BOX連接電供輸出端。使用2P防水接頭，#1接正(紅色)，#2接負(黑色)。
+ 電表接電腦(USB-B接USB-A)，電錶開啟有繼電器切換聲音是正常現象。
+ 電供接電腦。
+ 遠端重開機
